...
sed --in-place 's/\"\\\"//g' /tmp/PGYR19_P063020/OP_DTL_GNRL_PGYR2019_P06302020.subset.csv # "\" in records 4165259 and 4175609 (Recipient_Primary_Business_Street_Address_Line1) cause mysql to lose its column on import
