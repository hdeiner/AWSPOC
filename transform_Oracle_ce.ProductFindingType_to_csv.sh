...
sed --in-place --regexp-extended 's/ [0-9]+[0-9]+\:[0-9]+[0-9]+\:[0-9]+//g' ce.ProductFindingType.csv
...
cp ce.ProductFindingType.csv.mod ce.ProductFindingType.csv
rm ce.ProductFindingType.csv.mod
