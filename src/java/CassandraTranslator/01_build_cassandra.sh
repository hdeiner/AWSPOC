...
figlet -w 200 -f small "ANTLR Lexer and Parser Generation For Cassandra"
#rm -rf PlSqlCassandraTranslator-1.0-SNAPSHOT.jar
#rm -rf target
#mkdir target
rm -rf generated
mkdir generated
...
figlet -w 200 -f small "Create PlSqlCassandraTranslator"
...
#java -jar target/PlSqlCassandraTranslator-1.0-SNAPSHOT.jar $PWD/../examples/create_table.sql
java -jar target/PlSqlCassandraTranslator-1.0-SNAPSHOT.jar $PWD/./ddl.sql
